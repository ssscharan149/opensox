    ...
    return (
        ...
        >
            ...
            <div className="hidden md:flex items-center gap-4 tracking-tight text-lg font-light text-[#d1d1d1]">
                ...
                <Link href="#demo" className='cursor-pointer hover:text-white'>Demo</Link>
                <Link href="#HIW" className='cursor-pointer hover:text-white'>How it works</Link>
                <Link href="#Stats" className='cursor-pointer hover:text-white'>Stats</Link>
                <Link href="#Contact" className='cursor-pointer hover:text-white'>Contact</Link>
            </div>
            <div className="">

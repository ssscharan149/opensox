...
import { Heart, Smartphone, Copy, Check, ChevronUp } from "lucide-react";

interface SupportDropdownProps {
  theme?: "light" | "dark";
}

import { SUPPORT_CONFIG } from "@/lib/ox-constants";
...
const SupportDropdown: React.FC<SupportDropdownProps> = ({
  ...
  const razorPayUrl = SUPPORT_CONFIG.RAZORPAY_URL;
          ...
          >
            <div className="flex items-center gap-2 w-full mb-2">
              ...
              <div className="flex-1 text-left">
                ...
                >
                  Support a lil indie builder building something useful. ❤️
                </div>
              </div>
              <button
                onClick={copyUpiId}

...
export const DashboardHeader = () => {
    return (
        <div className="flex h-full w-full justify-between px-6">
            ...
            <div id="header-right-container" className="flex h-full w-[40%] items-center justify-end space-x-8">
                <Button className="font-semibold text-[15px] h-8 w-16 hover:bg-white-500 text-white bg-theme-color cursor-pointer">Start</Button>
